...
# This script configures all necessary GitHub Actions variables.
#
set -e

# --- CONFIGURATION ---
# TODO: Replace this with the raw URL of your variables.json file.
...
if [ -z "$TARGET_REPO" ]; then
    ...
    echo "Please make sure you are running this script from the root of your cloned workshop repository directory."
    exit 1
fi
...
# --- (Optional) Section for Secrets ---
# If you have actual secrets in the future, you would add prompts for them here.
# For this workshop, all values are treated as variables.
